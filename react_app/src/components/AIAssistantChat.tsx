  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'msg_1',
      sender: 'ai',
      text: 'Hello! I am your AI Strategy Assistant. Tell me your target goals, preferred exams (e.g. "Focus on JEE Math", "Target CLAT Law", "Focus on High-Yield 80/20"), and I will re-order and customize your Main Task List in real-time!',
